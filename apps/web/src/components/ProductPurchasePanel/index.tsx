...
import { getPrimaryVariantQuantity, isProductOutOfStock } from '@/utils/inventory';
...
export function ProductPurchasePanel({ product, className }: ProductPurchasePanelProps) {
  ...
  const handleAddToCart = () => {
    ...
    const meta = [product.roastLevel, product.tastingNotes].filter(Boolean).join(' • ');
  ...
  return (
    <div className={cn('w-full space-y-4', className)} data-testid="product-purchase-panel">
