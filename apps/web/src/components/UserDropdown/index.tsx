  ...
  const accountDropdown = (
    <DropdownMenu>
      <DropdownMenuTrigger className="cursor-pointer">
        <div data-testid="btn-dropdown" className="flex w-fit items-center gap-3.5">
          <Avatar
            email={email}
      ...
      <DropdownMenuContent sideOffset={0} className="mt-2 w-fit rounded-sm p-0 shadow-lg">
                ...
                ({ text = '', href = '', isSignOut = false }, index) => (
                  <Button
                    ...
                    className={cn(
                      ...
                      isUserProfile && href === ROUTES.USER_PROFILE && 'bg-accent text-primary',
                    )}
                    onClick={() => handleClick(href, isSignOut)}
                  >
                    {text}
