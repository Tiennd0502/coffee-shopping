...
describe('PriceRangeSlider', () => {
  it('renders the default title and formatted values', () => {
    render(
      <PriceRangeSlider value={[10, 50]} onValueChange={jest.fn()} currency="USD" locale="en-US" />,
    );
  ...
  it('renders a custom title', () => {
    render(<PriceRangeSlider value={[5, 25]} onValueChange={jest.fn()} title="Budget" />);
  ...
  it('normalizes the next value before calling onValueChange', () => {
    ...
    render(<PriceRangeSlider value={[10, 90]} onValueChange={handleValueChange} />);
