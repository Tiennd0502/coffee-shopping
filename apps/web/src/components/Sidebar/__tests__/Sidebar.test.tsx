...
import { Sidebar as ContainerSidebar, SidebarProvider } from '@/components/ui/sidebar';
...
describe('Dashboard Sidebar', () => {
  ...
  it('marks enabled item active when pathname matches', () => {
    ...
    expect(productsLink.closest('[data-slot="sidebar-menu-button"]')).toHaveAttribute(
      'data-active',
    );
  });
});
