...
export function ProductReviewsSection({
  ...
  return (
    <section
      className={cn('space-y-8 border-t border-primary/15 bg-transparent pt-14', className)}
    ...
    >
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Button
          ...
          onClick={() => toast.info('Reviews are read-only until we launch community accounts.')}
        >
          Write a Review
        </Button>
      </div>
