...
type SeparatorPrimitiveProps = React.ComponentPropsWithoutRef<typeof SeparatorPrimitive>;
  ...
  return (
    ...
    >
      <SeparatorPrimitive
        ...
        aria-label={text}
        className={cn(separatorTrackClasses, isHorizontal ? 'w-full' : 'min-h-0 flex-1 basis-0')}
        {...props}
      />
      {Boolean(text) && (
        <span
