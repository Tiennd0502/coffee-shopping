  ...
  <MenuPrimitive.Portal>
    ...
    >
      <MenuPrimitive.Popup
        ...
        className={cn(
          'z-50 max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-sm border border-outline-variant bg-surface-container-high p-1 text-on-surface shadow-md duration-100 outline-none',
...
const DropdownMenuItem = ({
  ...
  <MenuPrimitive.Item
    ...
    className={cn(
      ...
      '[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*="size-"])]:size-4 data-[variant=destructive]:[&_svg]:text-destructive',
      className,
    )}
    {...props}
  />
...
const DropdownMenuSubContent = ({
  ...
  <DropdownMenuContent
    ...
    className={cn(
      'min-w-24 w-auto rounded-sm border border-outline-variant bg-surface-container-high p-1 text-on-surface shadow-md',
