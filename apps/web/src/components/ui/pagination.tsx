...
function paginationChipClassName(isActive: boolean | undefined, disabled: boolean | undefined) {
  return cn(
...
function PaginationLink({ className, isActive, disabled, href, ...props }: PaginationLinkProps) {
  const chipClassName = cn(paginationChipClassName(isActive, disabled), className);
...
function PaginationNext({ className, disabled, ...props }: Omit<PaginationLinkProps, 'isActive'>) {
  return (
    <PaginationLink
