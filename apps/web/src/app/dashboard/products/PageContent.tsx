...
export const PageContent = () => {
  ...
  const normalizedCategoryId =
    categoryId && categoryOptions.some((option) => String(option.value) === categoryId)
      ? categoryId
      : null;
  ...
  const { data, isLoading, isError, error, refetch } = useProducts({
    ...
    ...(normalizedStatus ? { status: normalizedStatus as PRODUCT_STATUS } : {}),
  });
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6">
      <AlertDialog
        ...
        description={
          <p>
            Are you sure you want to delete <b>{pendingDelete?.name}</b>? This action cannot be
            undone.
          </p>
        }
        textAction="Delete"
      ...
      <header className="flex flex-wrap items-center justify-between gap-4">
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            <p className="text-lg text-muted-foreground">Oversee your catalog and inventory</p>
          </div>
        </div>
