...
import { ProfileCardSkeleton, OrderTableSkeleton } from './ProfileSkeleton';

export function ProfilePageView() {
  const { user, error, isSignedIn, isAuthLoaded, isLoading: isAuthLoading } = useAuth();
  ...
  const isAuthPending = !isAuthLoaded || isAuthLoading;
        ...
        {isOrdersLoading ? (
          ...
          <section className="space-y-8">
            <div className="flex items-center justify-between gap-4">
              <h2 className="font-headline text-3xl text-on-surface">Order History</h2>
              <Button
                disabled
                type="button"
                variant="secondary"
