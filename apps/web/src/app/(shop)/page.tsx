...
const HOME_DISABLED_ACTIONS = {
  BREW_GUIDES: MENU.some((item) => item.href === '/brew-guides' && item.disabled === true),
...
const HomePage = async () => {
  ...
  const curatedProducts =
    productsResult.ok === true
      ? productsResult.products.map((p) => mapProductToRoastCollection(p, EMPTY_IMAGE))
      : [];
          ...
          <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-16">
            <div className="z-10 flex flex-1 flex-col space-y-8">
              ...
              <h1 className="font-headline text-5xl leading-[1.1] text-on-surface md:text-6xl lg:text-7xl">
                Fuel Your <span className="italic text-primary-container">Code</span>
              </h1>
              <p className="max-w-lg text-lg leading-relaxed text-on-surface-variant">
                Precision-roasted beans designed for the deep-work state. Experience the chemical
                synergy of artisanal roasting and modern tech-culture.
              </p>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 flex flex-col justify-end gap-6 sm:mb-16 md:flex-row md:items-end">
              <div className="flex-1">
                ...
                <p className="text-on-surface-variant">The current roasting cycle favorites.</p>
              </div>
              <Link
                href="/roasts"
          ...
          <div className="flex flex-col items-center gap-16 lg:flex-row lg:gap-24">
            <div className="order-2 flex-1 lg:order-1">
              <div className="relative">
                ...
                <div className="absolute -top-10 -right-10 hidden rounded-full bg-primary p-10 shadow-xl xl:block xl:-right-12 xl:-top-12 xl:p-12">
                  <span className="font-headline text-2xl text-on-primary italic">Est. 2024</span>
                </div>
              </div>
            </div>
            <div className="order-1 flex-1 space-y-8 lg:order-2">
              <h2 className="font-headline text-4xl leading-tight text-on-surface md:text-5xl">
                The Science of the <span className="text-primary">Sensory Brew</span>
              </h2>
              <p className="text-lg leading-relaxed text-on-surface-variant">
                At CoffeeHub, we view coffee as a chemical catalyst for creativity. Our process
                isn&apos;t just about roasting; it&apos;s about optimizing the molecular profile of
                every bean to ensure your cognitive flow remains uninterrupted.
              </p>
              <p className="text-lg leading-relaxed text-on-surface-variant">
                We source exclusively from high-altitude estates where the soil&apos;s minerality
                translates into complex notes of dark chocolate, berry, and computational clarity.
              </p>
        ...
        <section className="bg-surface-container px-8 py-24 md:py-32">
          <div className="mx-auto max-w-7xl">
            <div className="mb-16 text-center md:mb-20">
              <span className="text-xs uppercase tracking-[0.2em] text-primary">The Community</span>
            ...
            <div className="grid grid-cols-1 gap-10 md:grid-cols-3 md:gap-12">
              {TESTIMONIALS.map((t) => (
                ...
                >
                  ...
                  <p className="mb-8 text-lg text-on-surface italic">&ldquo;{t.quote}&rdquo;</p>
