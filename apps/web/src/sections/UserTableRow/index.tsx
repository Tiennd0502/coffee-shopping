    ...
    <>
      <td className="min-w-0 px-6 py-4 align-middle">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0 flex-1 space-y-0.5">
            <p title={name || undefined} className="truncate font-semibold text-foreground">
              {name}
            </p>
            <p
            ...
            >
              <Badge
                className={cn(
                  ...
                  isAdmin ? 'bg-foreground text-background' : 'bg-primary/20 text-primary',
                )}
              >
                {rowRole}
      ...
      <td className="min-w-0 px-6 py-4 align-middle text-center">
        <div className="flex justify-center gap-1">
          <Button disabled size="icon-xs" variant="ghost" aria-label={`Edit ${name}`}>
