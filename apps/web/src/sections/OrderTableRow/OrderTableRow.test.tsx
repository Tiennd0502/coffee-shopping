...
describe('OrderTableRow', () => {
  it('renders order id, customer, and distinct status badges', () => {
    ...
    expect(screen.getByRole('button', { name: /View order #SB-9281/i })).toBeEnabled();
    expect(screen.getByRole('button', { name: /Delete order #SB-9281/i })).toBeEnabled();
  });
  ...
  it('calls onRequestView with current order when view clicked', async () => {
    ...
    await user.click(screen.getByRole('button', { name: /View order #SB-9281/i }));
  ...
  it('calls onRequestDelete with current order when delete clicked', async () => {
    ...
    await user.click(screen.getByRole('button', { name: /Delete order #SB-9281/i }));
  ...
  it('disables delete action when isDeleteDisabled is true', () => {
    ...
    expect(screen.getByRole('button', { name: /Delete order #SB-9281/i })).toBeDisabled();
  });
