...
const SignUpForm = () => {
  ...
  const handleSignUpStartClick = useCallback((event: MouseEvent<HTMLButtonElement>) => {
      ...
      <SignUp.Root
        fallback={
          <div className="flex justify-center py-20">
            <Spinner size="lg" label="Loading sign up form" className="text-primary" />
          </div>
        }
      >
        <Clerk.Loading>
                ...
                <div className="relative hidden min-h-[850px] overflow-hidden bg-surface-container lg:block">
                  ...
                  <div className="absolute inset-x-0 top-0 p-16">
                    ...
                    <p className="mt-6 max-w-md text-base leading-7 text-surface/80">
                      Join our community of tactile brewers and explore the complex chemistry behind
                      every single-origin roast.
                    </p>
                  </div>
                </div>
                <Clerk.Loading>
                        ...
                        <div className="mx-auto w-full max-w-md space-y-10">
                          <div className="space-y-2">
                            ...
                            <p className="text-base text-on-surface-variant">
                              Create your sensory profile to unlock a curated world of premium
                              coffee.
                            </p>
                          </div>
                    ...
                    return (
                      <div className="mx-auto w-full max-w-md space-y-8">
                        <div className="space-y-2">
                          ...
                          <p className="text-base text-on-surface-variant">
                            If your sign-in provider still needs extra details, submit this step or
                            go back to edit your information.
                          </p>
                        </div>

                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                          <SignUp.Action navigate="start" asChild disabled={isLoading}>
                            <Button
                              type="button"
                              variant="outline"
