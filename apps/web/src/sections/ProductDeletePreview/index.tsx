...
export function ProductDeletePreview({ name, imageUrl, price }: ProductDeletePreviewProps) {
  ...
  return (
    <div className="flex items-center gap-4 rounded-2xl bg-muted/60 p-4">
      ...
      <div className="min-w-0 text-left">
        ...
        <p className="text-sm text-muted-foreground">{formatPrice(price, 'en-US', 'USD')}</p>
      </div>
    </div>
  );
}
