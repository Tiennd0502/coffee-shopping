...
describe('CategoryTableRow', () => {
  it('calls onRequestDelete when remove is clicked', async () => {
    ...
    render(
      <table>
        <tbody>
          <tr>
            <CategoryTableRow category={activeCategory} onRequestDelete={onRequestDelete} />
          </tr>
        </tbody>
      </table>,
    );
  ...
  it('does not call onRequestDelete when archived', () => {
    ...
    expect(screen.getByRole('button', { name: /remove espresso/i })).toBeDisabled();
  ...
  it('exposes full slug via title on slug cell when slug is non-empty', () => {
    ...
    render(
      <table>
        <tbody>
          <tr>
            <CategoryTableRow category={{ ...activeCategory, slug: longSlug }} />
          </tr>
        </tbody>
      </table>,
    );
