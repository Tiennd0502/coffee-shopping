...
export function CategoryTableRow({ category, onRequestDelete }: CategoryTableRowProps) {
      ...
      <td className="min-w-0 px-6 py-4 align-middle">
        <div className="flex justify-end gap-1">
          {!isDeleted && category.id ? (
            ...
            <Button size="icon-xs" variant="ghost" aria-label={`Edit ${category.name}`} disabled>
              <Pencil className="size-4" aria-hidden />
            </Button>
          )}
          <Button
