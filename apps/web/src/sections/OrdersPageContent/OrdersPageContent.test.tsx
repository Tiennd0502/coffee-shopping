...
jest.mock('@/hooks/useOrder', () => ({
  ...
  useUpdateOrderStatus: (...args: unknown[]) => mockUseUpdateOrderStatus(...args),
  useUpdateOrderShippingStatus: (...args: unknown[]) => mockUseUpdateOrderShippingStatus(...args),
}));
...
describe('OrdersPageContent', () => {
  ...
  beforeEach(() => {
    mockUseOrders.mockReturnValue({
      data: { data: orders, meta: { currentPage: 1, pageCount: 1, limit: 10, totalCount: 1 } },
      isLoading: false,
      isError: false,
      error: null,
      refetch: jest.fn(),
