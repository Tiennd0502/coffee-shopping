...
export const MOCK_PRODUCT_REVIEWS: ProductReviewDisplay[] = [
  {
    ...
    rating: 5,
    quote: 'Bright acidity without harsh edges — exactly what I want from a washed Yirgacheffe.',
  ...
  },
  {
    ...
    rating: 5,
    quote: 'Floral on the nose and a clean finish. My go-to for weekend pour-overs.',
