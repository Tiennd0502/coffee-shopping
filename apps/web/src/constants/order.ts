...
export const ORDER_TRANSITIONS: Readonly<Record<ORDER_STATUS, readonly ORDER_STATUS[]>> = {
...
export const SHIPPING_TRANSITIONS: Readonly<Record<SHIPPING_STATUS, readonly SHIPPING_STATUS[]>> = {
